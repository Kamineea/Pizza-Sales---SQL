...
-- Calculate the total revenue genertaed from pizza sales.
 SELECT 
...
-- list the top 5 most ordered pizzastypes types 
...
-- Determine the distribution of orders by hour of the day.alter
SELECT 
...
-- calculate the percentage contribution the each 
...
-- based on revenue for each pizza category.alter
...
group by pizza_types.category, pizza_t
